...
small_emerald = items.item("A small Emerald", descriptions.small_emerald_description, 10)
large_diamond = items.item("A large Diamond", descriptions.large_diamond_description, 25)
...
hallway = rooms.room("Hallway", descriptions.hallway_description, "East", [torch])
chamber = rooms.room("Chamber", descriptions.chamber_description, "West", [rustic_bench, metal_bench, restraining_table])

# Initialize all the dungeon